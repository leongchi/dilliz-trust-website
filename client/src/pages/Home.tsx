    ...
    <Layout>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-left space-y-8">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Link 
                href="/services" 
                className="btn-gold py-4 px-8 font-bold text-xs tracking-widest uppercase inline-flex items-center gap-2"
              >
          ...
          <div className="lg:col-span-5 hidden lg:flex justify-center relative">
            ...
            <div className="relative w-80 h-80 rounded-full border border-metal-gold/20 flex items-center justify-center p-8 bg-[#2b2b2b]/30 backdrop-blur-md">
              <img 
      ...
      <section className="py-24 bg-[#1a1a1a] border-t border-white/5 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          {/* 左側：真實高清圖片 - 徹底移除所有遮罩、模糊、發光與 Logo 疊加，100% 銳利清晰呈現！ */}
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-3xl overflow-hidden border border-white/10 aspect-[4/3] md:aspect-[16/10] lg:aspect-[4/5]">
              <img 
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="pt-6">
              <Link href="/about" className="btn-gold py-3.5 px-8 font-bold text-xs tracking-widest uppercase inline-flex items-center gap-2">
      ...
      <section className="py-24 bg-[#2b2b2b] border-t border-b border-white/5 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 space-y-16">
              ...
              return (
                <div key={idx} className="flex">
                  <Link 
                    ...
                    className="bg-white/5 border border-white/10 p-6 rounded-2xl flex flex-col justify-between hover:border-metal-gold/40 transition-all duration-300 group cursor-pointer text-left w-full"
                  >
                    <div className="space-y-4">
          ...
          <div className="text-center pt-4">
            <Link href="/services" className="btn-gold py-3.5 px-8 font-bold text-xs tracking-widest uppercase inline-flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          ...
          <div className="flex">
            <div className="bg-white/5 border border-white/10 p-8 md:p-10 rounded-3xl flex flex-col justify-between hover:border-metal-gold/30 transition-all duration-300 relative overflow-hidden w-full">
              ...
              <div className="pt-8 mt-8 border-t border-white/5">
                <Link href="/cases" className="btn-gold py-3 px-6 font-bold text-xs tracking-widest uppercase inline-flex items-center gap-2 w-full justify-center">
          ...
          <div className="flex">
            <div className="bg-white/5 border border-white/10 p-8 md:p-10 rounded-3xl flex flex-col justify-between hover:border-metal-gold/30 transition-all duration-300 relative overflow-hidden w-full">
              ...
              <div className="pt-8 mt-8 border-t border-white/5">
                <Link href="/membership" className="btn-gold py-3 px-6 font-bold text-xs tracking-widest uppercase inline-flex items-center gap-2 w-full justify-center">
      ...
      <section className="py-20 bg-[#2b2b2b] border-t border-white/5 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-6 relative z-10 space-y-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-4">
            <Link 
              href="/contact" 
              className="btn-gold py-4 px-10 font-bold text-xs tracking-widest uppercase inline-flex items-center gap-2"
            >
